...
enum class InterfaceDestination(
    ...
    ATTACK(interfaceId = 593, fixedChildId = 80, resizeChildId = 76, resizeListChildId = 72, fullscreenChildId = 15),
    SKILLS(interfaceId = 320, fixedChildId = 81, resizeChildId = 77, resizeListChildId = 73, fullscreenChildId = 16),
    QUEST_ROOT(interfaceId = 629, fixedChildId = 82, resizeChildId = 78, resizeListChildId = 74, fullscreenChildId = 17),
    INVENTORY(interfaceId = 149, fixedChildId = 83, resizeChildId = 79, resizeListChildId = 75, fullscreenChildId = 18),
    EQUIPMENT(interfaceId = 387, fixedChildId = 84, resizeChildId = 80, resizeListChildId = 76, fullscreenChildId = 19),
    PRAYER(interfaceId = 541, fixedChildId = 85, resizeChildId = 81, resizeListChildId = 77, fullscreenChildId = 20),
    MAGIC(interfaceId = 218, fixedChildId = 86, resizeChildId = 82, resizeListChildId = 78, fullscreenChildId = 21),
    CLAN_CHAT(interfaceId = 707, fixedChildId = 87, resizeChildId = 83, resizeListChildId = 79, fullscreenChildId = 22),
    ACCOUNT_MANAGEMENT(interfaceId = 109, fixedChildId = 88, resizeChildId = 84, resizeListChildId = 80, fullscreenChildId = 23),
    SOCIAL(interfaceId = 429, fixedChildId = 89, resizeChildId = 85, resizeListChildId = 81, fullscreenChildId = 24),
    LOG_OUT(interfaceId = 182, fixedChildId = 90, resizeChildId = 86, resizeListChildId = 82, fullscreenChildId = 25),
    SETTINGS(interfaceId = 116, fixedChildId = 91, resizeChildId = 87, resizeListChildId = 83, fullscreenChildId = 26),
    EMOTES(interfaceId = 216, fixedChildId = 92, resizeChildId = 88, resizeListChildId = 84, fullscreenChildId = 27),
    MUSIC(interfaceId = 239, fixedChildId = 93, resizeChildId = 89, resizeListChildId = 85, fullscreenChildId = 28),
    ...
    TAB_AREA(interfaceId = -1, fixedChildId = 77, resizeChildId = 74, resizeListChildId = 70, clickThrough = false), // @TODO
    WALKABLE(interfaceId = -1, fixedChildId = 9, resizeChildId = 3, resizeListChildId = 3),
    WORLD_MAP(interfaceId = -1, fixedChildId = 42, resizeChildId = 18, resizeListChildId = 15, fullscreenChildId = 36),
