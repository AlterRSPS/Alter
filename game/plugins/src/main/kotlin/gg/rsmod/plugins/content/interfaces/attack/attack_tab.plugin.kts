...
import gg.rsmod.plugins.content.interfaces.attack.AttackTab.ATTACK_TAB_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.attack.AttackTab.ATTACK_STYLE_VARP
import gg.rsmod.plugins.content.interfaces.attack.AttackTab.DISABLE_AUTO_RETALIATE_VARP
