package gg.rsmod.plugins.content.interfaces.kod

import gg.rsmod.plugins.api.EquipmentType.Companion.EQUIPMENT_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.kod.KeptOnDeath.KOD_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.kod.KeptOnDeath.KOD_COMPONENT_ID
