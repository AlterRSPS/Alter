...
enum class Prayer(val named: String, val child: Int, val quickPrayerSlot: Int, val varbit: Int,
    ...
    BURST_OF_STRENGTH(named = "Burst of Strength", child = 10, quickPrayerSlot = 1, varbit = 4105, level = 4, sound = 2688, drainEffect = 3,
            group = PrayerGroup.STRENGTH, overlap = *arrayOf(PrayerGroup.RANGED, PrayerGroup.MAGIC, PrayerGroup.COMBAT)),

    CLARITY_OF_THOUGHT(named = "Clarity of Thought", child = 11, quickPrayerSlot = 2, varbit = 4106, level = 7, sound = 2664, drainEffect = 3,
    ...
    SUPERHUMAN_STRENGTH(named = "Superhuman Strength", child = 13, quickPrayerSlot = 4, varbit = 4108, level = 13, sound = 2689, drainEffect = 6,
            group = PrayerGroup.STRENGTH, overlap = *arrayOf(PrayerGroup.RANGED, PrayerGroup.MAGIC, PrayerGroup.COMBAT)),

    IMPROVED_REFLEXES(named = "Improved Reflexes", child = 14, quickPrayerSlot = 5, varbit = 4109, level = 16, sound = 2662, drainEffect = 6,
            group = PrayerGroup.ATTACK, overlap = *arrayOf(PrayerGroup.RANGED, PrayerGroup.MAGIC, PrayerGroup.COMBAT)),

    RAPID_RESTORE(named = "Rapid Restore", child = 15, quickPrayerSlot = 6, varbit = 4110, level = 19, sound = 2679, drainEffect = 1,
            group = null, overlap = *arrayOf()),

    RAPID_HEAL(named = "Rapid Heal", child = 16, quickPrayerSlot = 7, varbit = 4111, level = 22, sound = 2678, drainEffect = 2,
            group = null, overlap = *arrayOf()),
    ...
    ULTIMATE_STRENGTH(named = "Ultimate Strength", child = 19, quickPrayerSlot = 10, varbit = 4114, level = 31, sound = 2691, drainEffect = 12,
            group = PrayerGroup.STRENGTH, overlap = *arrayOf(PrayerGroup.RANGED, PrayerGroup.MAGIC, PrayerGroup.COMBAT)),

    INCREDIBLE_REFLEXES(named = "Incredible Reflexes", child = 20, quickPrayerSlot = 11, varbit = 4115, level = 34, sound = 2667, drainEffect = 12,
            group = PrayerGroup.ATTACK, overlap = *arrayOf(PrayerGroup.RANGED, PrayerGroup.MAGIC, PrayerGroup.COMBAT)),

    PROTECT_FROM_MAGIC(named = "Protect from Magic", child = 21, quickPrayerSlot = 12, varbit = 4116, level = 37, sound = 2675, drainEffect = 12,
            group = PrayerGroup.OVERHEAD, overlap = *arrayOf()),

    PROTECT_FROM_MISSILES(named = "Protect from Missiles", child = 22, quickPrayerSlot = 13, varbit = 4117, level = 40, sound = 2677, drainEffect = 12,
            group = PrayerGroup.OVERHEAD, overlap = *arrayOf()),
    ...
    RETRIBUTION(named = "Retribution", child = 24, quickPrayerSlot = 15, varbit = 4119, level = 46, sound = 2682, drainEffect = 3,
            group = PrayerGroup.OVERHEAD, overlap = *arrayOf()),

    REDEMPTION(named = "Redemption", child = 25, quickPrayerSlot = 16, varbit = 4120, level = 49, sound = 2680, drainEffect = 6,
            group = PrayerGroup.OVERHEAD, overlap = *arrayOf()),

    SMITE(named = "Smite", child = 26, quickPrayerSlot = 26, varbit = 4121, level = 52, sound = 2686, drainEffect = 18,
            group = PrayerGroup.OVERHEAD, overlap = *arrayOf()),
