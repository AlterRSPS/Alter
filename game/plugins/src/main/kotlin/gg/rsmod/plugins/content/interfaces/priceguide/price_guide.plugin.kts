package gg.rsmod.plugins.content.interfaces.priceguide

import gg.rsmod.plugins.api.EquipmentType.Companion.EQUIPMENT_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.priceguide.PriceGuide.PRICE_GUIDE_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.priceguide.PriceGuide.PRICE_GUIDE_TAB_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.priceguide.PriceGuide.add
import gg.rsmod.plugins.content.interfaces.priceguide.PriceGuide.close
import gg.rsmod.plugins.content.interfaces.priceguide.PriceGuide.depositInventory
import gg.rsmod.plugins.content.interfaces.priceguide.PriceGuide.remove
import gg.rsmod.plugins.content.interfaces.priceguide.PriceGuide.search
