...
//
//        put(OpObj1Message::class.java, OpObj1Decoder(), OpObjHandler(), structures)
...
//
//        put(OpNpc1Message::class.java, OpNpc1Decoder(), OpNpcHandler(), structures)
...
//
//        put(OpPlayer1Message::class.java, OpPlayer1Decoder(), OpPlayerHandler(), structures)
...
//        //put(MessagePrivateSenderMessage::class.java, MessagePrivateSenderDecoder(), MessagePrivateSenderHandler(), structures)
    ...
    fun getHandler(opcode: Int): MessageHandler<IncomingGameMessage>? {
        return handlers[opcode] as MessageHandler<IncomingGameMessage>?
    }
}