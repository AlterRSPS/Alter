...
suspend fun QueueTask.what_is_achievement_diary() {
    ...
    chatNpc(
        "It's a diary that helps you keep track of particular<br>achievements. In the Wilderness it can help you<br>discover some quite useful things. Eventually, with<br>enough exploration, the inhabitants will reward you.",
        animation = 591,
    )
...
suspend fun QueueTask.what_are_rewards() {
    chatNpc(
        "Well, there are four different Wilderness Swords, which<br>match up with the four levels of difficulty. Each has the<br>same rewards as the previous level and some additional<br>benefits too... which tier of rewards would you like to",
        animation = 570,
    )
...
suspend fun QueueTask.easy_rewards() {
    ...
    chatNpc(
        "If you complete all of the easy tasks in the Wilderness,<br>you can speak to Lundail at the Mage Arena every day<br>to receive 10 free runes and you can teleport to either<br>Edgeville or Ardougne from the Wilderness lever.",
        animation = 570,
    )
...
suspend fun QueueTask.medium_rewards() {
    ...
    chatNpc(
        "In addition to the easy rewards, Mandrith will give you<br>a 20% discount off entry to the Resource Area, you'll<br>cut Ents faster, you can access a shortcut in the deep<br>Wilderness dungeon. You can also own 4 ecumenical",
        animation = 570,
    )
...
suspend fun QueueTask.hard_rewards() {
    ...
    chatNpc(
        "In addition to the easy and medium benefits, the sword<br>can teleport you to the Fountain of Rune once per<br>day, you'll get 50% more lava shards when grinding<br>scales and even cheaper access to the Resource Area.",
        animation = 570,
    )
    chatNpc(
        "You can own 5 ecumenical keys, access a shortcut to<br>Lava Dragon Isle and Lundail will give you 30 free<br>runes each day. You can also control which Obelisk you<br>want to travel to.",
        animation = 570,
    )
    chatPlayer("Thanks!", animation = 567)
}
...
suspend fun QueueTask.elite_rewards() {
    ...
    chatNpc(
        "In addition to the previous tiers of rewards, access to<br>the Resource Area is free and the sword will now give<br>you unlimited teleports to the Fountain of Rune. All<br>dragon bone drops in the Wilderness become noted and",
        animation = 570,
    )
...
suspend fun QueueTask.claim_rewards() {
    ...
    chatNpc(
        "Just complete the tasks in the Wilderness so they're<br>ticked off, then come and speak to me for your<br>rewards.",
        animation = 590,
    )
    options()
}
