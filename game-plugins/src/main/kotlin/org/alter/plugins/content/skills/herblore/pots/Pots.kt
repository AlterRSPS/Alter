...
enum class Pots(val pot: Pot) {
    ATTACK(
        Pot(
            ...
            Items.EYE_OF_NEWT,
            intArrayOf(Items.ATTACK_POTION1, Items.ATTACK_POTION2, Items.ATTACK_POTION3, Items.ATTACK_POTION4),
            3,
            25.0,
        ),
    ),
    ANTIPOISON(
        Pot(
            ...
            Items.UNICORN_HORN_DUST,
            intArrayOf(Items.ANTIPOISON1, Items.ANTIPOISON2, Items.ANTIPOISON3, Items.ANTIPOISON4),
            5,
            37.5,
        ),
    ),
    RELICYMS_BALM(
        Pot(
            Items.UNFINISHED_POTION_4840,
            Items.SNAKE_WEED,
            intArrayOf(Items.RELICYMS_BALM1, Items.RELICYMS_BALM2, Items.RELICYMS_BALM3, Items.RELICYMS_BALM4),
            8,
            40.0,
        ),
    ),
    STRENGTH(
        Pot(
            ...
            Items.LIMPWURT_ROOT,
            intArrayOf(Items.STRENGTH_POTION1, Items.STRENGTH_POTION2, Items.STRENGTH_POTION3, Items.STRENGTH_POTION4),
            12,
            50.0,
        ),
    ),
    SERUM_207(
        Pot(
            Items.TARROMIN_POTION_UNF,
            Items.ASHES,
            intArrayOf(Items.SERUM_207_1, Items.SERUM_207_2, Items.SERUM_207_3, Items.SERUM_207_4),
            15,
            50.0,
        ),
    ),
    COMPOST(
        Pot(
            ...
            Items.VOLCANIC_ASH,
            intArrayOf(Items.COMPOST_POTION1, Items.COMPOST_POTION2, Items.COMPOST_POTION3, Items.COMPOST_POTION4),
            22,
            60.0,
        ),
    ),
    RESTORE(
        Pot(
            Items.HARRALANDER_POTION_UNF,
            Items.RED_SPIDERS_EGGS,
            intArrayOf(Items.RESTORE_POTION1, Items.RESTORE_POTION2, Items.RESTORE_POTION3, Items.RESTORE_POTION4),
            22,
            62.5,
        ),
    ),
