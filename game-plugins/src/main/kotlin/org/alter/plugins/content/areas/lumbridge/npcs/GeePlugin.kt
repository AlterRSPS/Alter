...
class GeePlugin (
    ...
    private suspend fun QueueTask.howAreYou() {
    ...
    private suspend fun QueueTask.anyQuests() {
    ...
    private suspend fun QueueTask.stick() {
    ...
    private suspend fun QueueTask.shoelace() {
