...
suspend fun QueueTask.oreYouMine() {
    ...
    chatNpc(
        "What do you think? We smelt it into bars, smith the<br>metal to make armour and weapons, then we exchange<br>them for goods and services.",
    )
    chatPlayer("I don't see many dwarves<br><br>selling armour or weapons here.")
    chatNpc(
        "No, this is only a mining outpost. We dwarves don't<br>much like to settle in human cities. Most of the ore is<br>carted off to keldagrim, the great dwarven city.<br>They've got a special blast furnace up there - it makes",
    )
    chatNpc(
        "smelting the ore so much easier. There are plenty of<br>dwarven traders working in keldagrim. Anyway, can I<br>help you with anything else?",
    )
