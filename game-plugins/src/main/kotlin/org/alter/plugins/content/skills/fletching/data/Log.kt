...
enum class Log(val id: Int, val whittleOptions: Array<WhittleItem>) {
    ...
    MAGIC(
        ...
        whittleOptions =
            arrayOf(
                WhittleItem.ARROW_SHAFT_90,
                WhittleItem.MAGIC_SHORTBOW_U,
                WhittleItem.MAGIC_LONGBOW_U,
                WhittleItem.MAGIC_STOCK,
                WhittleItem.MAGIC_SHIELD,
            ),
    ),
    ...
    companion object {
        ...
        val logDefinitions =
            values().associate { log ->
                log.id to
                    log.whittleOptions.associate { whittleOption ->
