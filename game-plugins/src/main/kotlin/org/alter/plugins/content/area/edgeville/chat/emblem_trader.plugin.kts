...
suspend fun QueueTask.chat() {
    chatNpc(
        "Don't suppose you've come across any strange...<br>emblems or artefacts along your journey? Ancient<br>artifacts?",
        animation = 588,
    )
    chatNpc("Nothing to report now.", animation = 589)
    chatNpc(
        "If you find any, please bring them to me. I am happy<br>to offer rewards for such items. My master is pleased<br>by your interest, so I'll mark that task off on your<br>diary.",
        animation = 588,
    )
    options()
}
...
suspend fun QueueTask.coffer_option() {
    ...
    when (options("Ask about the coffer", "Deposit", "Other options")) {
        1 -> {
            chatNpc(
                "Anyone wishing to participate in the Targeting system<br>must take a little risk, if they wish to be considered a<br>worthy opponent.",
            )
            itemMessageBox(
                "They may put money in their Target Coffer here, by<br>talking to me. They must store at least <col=7f0000>20,000 coins</col> to<br>play.",
                item = 1004,
            )
            chatNpc(
                " If another person kills you in the Wilderness on a<br>Target world, <col=7f0000>20,000 coins</col> will be taken from your<br>Coffer, and given to your killer.",
            )
            chatNpc(
                "Any surplus money in your Coffer will remain safe,<br>here, with me. Only <col=7f0000>20,000 coins</col> will be taken from it<br>as you die.",
            )
            coffer_option()
        }
        2 -> {
