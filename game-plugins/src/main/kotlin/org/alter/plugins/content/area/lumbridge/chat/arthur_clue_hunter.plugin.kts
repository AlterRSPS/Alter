...
suspend fun QueueTask.dialog() {
    when (
        ...
        1 -> {
            ...
            chatNpc(
                "Slaying monsters for a chance at a clue beging dropped. I hear goblins are sneaky, maybe they have some clue scrolls on them ripe for the taking.",
            )
            chatNpc("Maybe someone left one in the cow field, who knows<br><br>where you could obtain them.")
            chatNpc(
                "Beginner clues have also been known to be left in<br>geodes while mining, as well as somethings in bottles that<br>you may fish up from time to time and from nests<br>which fall out of trees.",
            )
        ...
        2 -> {
            ...
            chatNpc(
                "You can gain advances clues the same way you would<br>get a beginner clue. But to get higher tier scrolls you<br>will need to defeat more powerful foes.",
            )
            chatNpc(
                "The chance to get a higher tier clue from geodes,<br>bottles and nests is lower the higher the tier. But if you<br>chop down highter-level trees you will have a higher<br>chance of receiving a nest which contains a clue. Same",
            )
            chatNpc("with fishing and mining.")
            chatNpc("The only exception to this is master clue scrolls.")
            chatNpc(
                "Master clues can only be obtained as a rare chance when opening your casket or by handing in one of every type of clue, apart from beginner, to Watson who resides in Hosidius.",
            )
        ...
        4 -> {
            if (player.getVarbit(9365) == 0) {
                ...
                chatNpc(
                    "Vessel containers include mining geodes, fishing bottles<br>and clue nests. Are you sure you want to stop<br>receiving them?",
                )
            ...
            if (player.getVarbit(9365) == 1) {
                ...
                chatNpc(
                    "Vessel containers include mining geodes, fishing bottles<br>and clue nests. Are you sure you want to start<br>receiving them, again?",
                )
...
suspend fun QueueTask.clueTypes() {
    when (options("Anagrams.", "Challenge scrolls.", "Cipher clues.", "Coordinate clues.", "More.")) {
        1 -> {
            chatNpc(
                "This type of clue has you talk to someone around<br>Gielinore. Although the clue does not tell you exactly who<br> to talk to.",
            )
            chatNpc(
                "You will see a couple of words that may or may not<br>make sense together. You will have to rearrange the<br>letters to make the name of the person you need to talk<br>to.",
            )
            clueTypes()
        }
        2 -> {
            chatNpc(
                "This type of clue has you work out a logical problem<br>for the person you need to talk to. This type of<br>challenge only appears in clue tiers medium, hard and<br>elite.",
            )
        ...
        3 -> {
            chatNpc(
                "This type of clues has you talk to someone around<br>Gielinor. Although the clue does not tell you exactly who<br>to talk to. This type of challenge only appears in clue<br>tiers medium, hard and elite.",
            )
        ...
        4 -> {
            chatNpc(
                "This type of clue will have you use a sextant, chart and<br>a watch to find out the place you will need to dig. This<br>type of challenge only appears in clue tiers medium and<br>above.",
            )
...
suspend fun QueueTask.moreClues() {
    when (options("Cryptic clues.", "Emote clues.", "Hot Cold clues.", "Puzzle clues.", "More.")) {
        1 -> {
            ...
            chatNpc(
                "But the higher the tier of clue, the more steps you will<br>have to do beforehand. An example of this would be<br>needing to find a key before opening a chest.",
            )
        ...
        3 -> {
            chatNpc(
                "Depending on the tier of clue, you will need to obtain a<br>strange device from either Reldo, located in Varrock, or<br>Jorral, located south of Tree Gnome Stronghold.",
            )
        ...
        4 -> {
            chatNpc(
                "There are many different puzzles that you can come<br>across while doing clues. These range from light boxes<br>to puzzle boxes.",
            )
            chatNpc(
                "Puzzle boxes are puzzles that will have you complete a<br>slider puzzle that, when complete, will look like an image<br>in game.",
            )
            chatNpc("Light boxes are a puzzle which contains a 5 by 5 grid<br><br>of lights with some lights on and some lights off.")
            chatNpc(
                "The puzzle will have you click the buttons below to turn<br>on or off some of the lights with the end goal being,<br>having all the lights turned on.",
            )
