...
enum class BowType(val item: Int, val ammo: Array<Int>) {
    ...
    BLUE_DARK_BOW(
        item = Items.DARK_BOW_12765,
        ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + AMETHYST_ARROWS + DRAGON_ARROWS,
    ),
    GREEN_DARK_BOW(
        item = Items.DARK_BOW_12766,
        ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + AMETHYST_ARROWS + DRAGON_ARROWS,
    ),
    WHITE_DARK_BOW(
        item = Items.DARK_BOW_12767,
        ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + AMETHYST_ARROWS + DRAGON_ARROWS,
    ),
    YELLOW_DARK_BOW(
        item = Items.DARK_BOW_12768,
        ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + AMETHYST_ARROWS + DRAGON_ARROWS,
    ),

    THIRD_AGE_BOW(
        item = Items._3RD_AGE_BOW,
        ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + AMETHYST_ARROWS + DRAGON_ARROWS,
    ),
