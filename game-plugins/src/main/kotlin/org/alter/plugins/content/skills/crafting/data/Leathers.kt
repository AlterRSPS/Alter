...
enum class Leathers(val id: Int, val leatherOptions: Array<LeatherItem>) {
    LEATHER(
        ...
        leatherOptions =
            arrayOf(
                LeatherItem.LEATHER_GLOVES,
                LeatherItem.LEATHER_BOOTS,
                LeatherItem.LEATHER_COWL,
                LeatherItem.LEATHER_VAMBRACES,
                LeatherItem.LEATHER_BODY,
                LeatherItem.LEATHER_CHAPS,
                LeatherItem.COIF,
            ),
    ),
    ...
    SNAKESKIN(
        ...
        leatherOptions =
            arrayOf(
                LeatherItem.SNAKESKIN_BOOTS,
                LeatherItem.SNAKESKIN_VAMBRACES,
                LeatherItem.SNAKESKIN_BANDANA,
                LeatherItem.SNAKESKIN_CHAPS,
                LeatherItem.SNAKESKIN_BODY,
            ),
    ),
    ;
    ...
    companion object {
         ...
         */
        val leatherDefinitions =
            values().associate { leathers ->
                leathers.id to
                    leathers.leatherOptions.associate { leatherOptions ->
