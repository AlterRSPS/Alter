...
enum class PickpocketNpc(
    ...
    CAVE_GOBLIN(
        npcIds =
            intArrayOf(
                Npcs.CAVE_GOBLIN_2268,
                Npcs.CAVE_GOBLIN_2269,
                Npcs.CAVE_GOBLIN_2270,
                Npcs.CAVE_GOBLIN_2271,
                Npcs.CAVE_GOBLIN_2272,
                Npcs.CAVE_GOBLIN_2273,
                Npcs.CAVE_GOBLIN_2274,
                Npcs.CAVE_GOBLIN_2275,
                Npcs.CAVE_GOBLIN_2276,
                Npcs.CAVE_GOBLIN_2277,
                Npcs.CAVE_GOBLIN_2278,
                Npcs.CAVE_GOBLIN_2279,
                Npcs.CAVE_GOBLIN_2280,
                Npcs.CAVE_GOBLIN_2281,
                Npcs.CAVE_GOBLIN_2282,
                Npcs.CAVE_GOBLIN_2283,
                Npcs.CAVE_GOBLIN_2284,
                Npcs.CAVE_GOBLIN_2285,
            ),
        experience = 40.0,
        reqLevel = 36,
        rewards =
    ...
    KNIGHT(
        npcIds =
            intArrayOf(
                Npcs.KNIGHT_OF_ARDOUGNE_3297,
                Npcs.KNIGHT_OF_ARDOUGNE_3300,
            ),
        experience = 84.3,
        reqLevel = 55,
        rewards =
    ...
    GNOME(
        npcIds =
            intArrayOf(
                Npcs.GNOME_5130,
                Npcs.GNOME_CHILD,
                Npcs.GNOME_CHILD_6078,
                Npcs.GNOME_CHILD_6079,
                Npcs.GNOME_WOMAN,
                Npcs.GNOME_WOMAN_6087,
                Npcs.GNOME_6094,
                Npcs.GNOME_6095,
                Npcs.GNOME_6096,
            ),
