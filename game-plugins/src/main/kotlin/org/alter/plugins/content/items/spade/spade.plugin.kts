...
on_item_option(item = Items.SPADE, "dig") {
    player.animate(830)
    if (player.tile.x == 3229 && player.tile.y == 3209 && player.inventory.contains(Items.TREASURE_SCROLL)) {
        player.queue {
    ...
    } else if (player.tile.x == 3202 && player.tile.y == 3211 && player.inventory.contains(Items.TREASURE_SCROLL_23068)) {
        player.queue {
    ...
    } else if (player.tile.x == 3108 && player.tile.y == 3264 && player.inventory.contains(Items.MYSTERIOUS_ORB_23069)) {
        player.queue {
    ...
    } else if (player.tile.x == 3077 && player.tile.y == 3260 && player.inventory.contains(Items.TREASURE_SCROLL_23070)) {
        player.queue {
