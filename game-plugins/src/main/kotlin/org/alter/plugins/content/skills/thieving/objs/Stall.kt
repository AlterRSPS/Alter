...
import org.alter.plugins.content.skills.thieving.objs.StallRewards.crafting_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.crossbow_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.fish_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.food_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.fruit_stall_steals
...
import org.alter.plugins.content.skills.thieving.objs.StallRewards.general_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.magic_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.market_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.scimitar_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.seed_stall_steals
...
import org.alter.plugins.content.skills.thieving.objs.StallRewards.special_gem_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.special_ore_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.spice_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.tea_stall_steals
import org.alter.plugins.content.skills.thieving.objs.StallRewards.vegetable_stall_steals
...
object StallRewards {
    ...
    val silk_stall_steals =
        arrayOf(
            StallItem(Items.SILK),
        )

    val fruit_stall_steals =
        arrayOf(
    ...
    val spice_stall_steals =
        arrayOf(
            StallItem(Items.SPICE),
        )

    val fur_stall_steals =
        arrayOf(
            StallItem(Items.GREY_WOLF_FUR),
        )

    val silver_stall_steals =
        arrayOf(
            StallItem(Items.SILVER_ORE),
        )

    val gem_stall_steals =
        arrayOf(
    ...
    val tea_stall_steals =
        arrayOf(
            StallItem(Items.CUP_OF_TEA_1978),
        )

    val food_stall_steals =
        arrayOf(
            StallItem(Items.BANANA),
        )

    val general_stall_steals =
        arrayOf(
