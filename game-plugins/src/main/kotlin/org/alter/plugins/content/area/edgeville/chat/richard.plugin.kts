...
spawn_npc(npc = Npcs.RICHARD_2200, x = 3102, y = 3518, walkRadius = 2)
...
suspend fun QueueTask.options() {
    when (options("What's so special about your capes?", "Yes please!", "No thanks.")) {
        1 -> {
            ...
            chatNpc(
                "Ahh well they make it less likely that you'll accidently<br>attack anyone wearing the same cape as you and easier<br>to attack everyone else. They also make it easier to<br>distinguish people who're wearing the same cape as you",
                animation = 570,
            )
            chatNpc(
                "from everyone else. They're very useful when out in<br>the wilderness with friends or anyone else you don't<br>want to harm.",
                animation = 569,
            )
