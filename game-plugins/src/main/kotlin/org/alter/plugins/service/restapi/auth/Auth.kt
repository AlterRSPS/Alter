package org.alter.plugins.service.restapi.auth
...
class Auth {
    companion object {
        ...
        private fun generate(): String =
            (1..64).map { _ -> kotlin.random.Random.nextInt(0, charPool.size) }.map(charPool::get).joinToString("")
